...
#define DC_PWM1_Pin GPIO_PIN_6
#define DC_PWM1_GPIO_Port GPIOC
#define DC_PWM2_Pin GPIO_PIN_7
#define DC_PWM2_GPIO_Port GPIOC
#define DC_PWM3_Pin GPIO_PIN_8
#define DC_PWM3_GPIO_Port GPIOC
